        ...
        while state != stStop:
            ...
            if state == stGetValueDecoderByTag:
                ...
                if debug.logger and debug.logger & debug.flagDecoder:
                    ...
                    state == stDecodeValue and 'value' or 'as explicit tag'))
                    debug.scope.push(
            ...
            if state == stGetValueDecoderByAsn1Spec:
                    ...
                    if debug.logger and debug.logger & debug.flagDecoder:
                        ...
                        if asn1Spec.getNegMap():
                            ...
                            for i in asn1Spec.getNegMap().items():
                                debug.logger('  %r -> %s' % (t, v.__class__.__name__))
                        debug.logger('new candidate ASN.1 spec is %s, chosen by %r' % (
                        __chosenSpec is None and '<none>' or __chosenSpec.__class__.__name__, tagSet))
                else:
                ...
                if debug.logger and debug.logger & debug.flagDecoder:
                    ...
                    state == stDecodeValue and concreteDecoder.__class__.__name__ or "<none>",
                    state == stDecodeValue and 'value' or 'as explicit tag'))
            ...
            if state == stTryAsExplicitTag:
                ...
                concreteDecoder and concreteDecoder.__class__.__name__ or "<none>",
                state == stDecodeValue and 'value' or 'as failure'))
            ...
            if state == stDecodeValue:
                ...
                debug.logger and debug.logger & debug.flagDecoder and debug.logger(
                    ...
                    concreteDecoder.__class__.__name__, value.__class__.__name__, value.prettyPrint(),
